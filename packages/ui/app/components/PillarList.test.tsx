...
describe("PillarList", () => {
  ...
  it("displays task status stats for each pillar", () => {
    ...
    render(
      <PillarList pillars={[makePillar("infra", "Infrastructure", tasks)]} onUpdate={vi.fn()} />,
    );
  ...
  it("renders short-term and long-term goal bullet lists with evaluation", () => {
    const pillar = {
      ...
      short_term_goal: [
        { id: "infra-stg-001", text: "Running on bare metal", evaluation: "at_risk" },
      ],
      long_term_goal: [
        { id: "infra-ltg-001", text: "Fully on Kubernetes", evaluation: "on_track" },
      ],
    };
